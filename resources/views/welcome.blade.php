...
<body class="antialiased">
    <div
        ...
        {{-- <div id="ad">
            <iframe src="https://test.canyousing.com.ng/adcode/2&0&2&250&7&59&500&3" scrolling="no" allowtransparency="true"
                width="301px" height="201px" style="border:0;">
            </iframe>
        </div> --}}
        <div id="ad"> <iframe src="http://localhost:8000/adcode/5&0&2&250&7&59&200&3"  allowtransparency="true" width = "300px" height= "250px" style="border:0;"> </iframe> </div>
        {{-- <div id="ad"> <iframe src="https://test.canyousing.com.ng/adcode/16&0&2&301&7&59&201&6" scrolling="no" allowtransparency="true" width = "301px" height= "201px" style="border:0"> </iframe> </div> --}}
        <img src="/storage/{{ $trim}}" alt="test" />
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form id="contactForm" role="form">
                ...
                <input type="text" name="salesPhone" id="salesPhone" value="+2347054528890" hidden />
