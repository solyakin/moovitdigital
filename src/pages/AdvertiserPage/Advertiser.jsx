                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="content where">
                                ...
                                <h5>DISPLAYS IN +10K PUBLISHER SITES</h5>
                                <p>Your ads will be shown in +100K publisher sites in our network with the filtration you set while creating a campaign.</p>
                            </div>
                        </div>
                    </div>
                </div>
